<div id="import-matakuliah" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 border-b rounded-t md:p-5 dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="import-matakuliah">
            ...
            <div class="p-4 md:p-5">
                <form action="{{ route('import-mata-kuliah') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div>
