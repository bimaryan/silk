        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 space-y-4">
                <form action="{{ route('peminjaman.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-5">
                        <label for="anggota_kelompok" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Nama Anggota
                        </label>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" id="kelas_id" name="kelas_id" value="{{ auth()->user()->kelas->nama_kelas }}" readonly
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" />
                    </div>
                    <div class="mb-5">
                        ...
                        <input type="text" id="nama_dosen" name="nama_dosen" placeholder="Masukkan Nama Dosen Pengampu"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" />
                    </div>
                    <div class="mb-5">
                    ...
                    <div class="mb-5">
                        <label for="ruangan_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Ruang Praktikum
                        </label>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="datetime-local" name="tanggal_waktu_peminjaman" id="tanggal_waktu_peminjaman" required
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" />
                    </div>
                    <div class="mb-5">
                    ...
                    <div class="mb-5">
                        <label for="dokumenspo_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Dokumen SPO
                        </label>
