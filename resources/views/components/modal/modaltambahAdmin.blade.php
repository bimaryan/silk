<div id="tambah-admin-dan-staff" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 border-b rounded-t md:p-5 dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="tambah-admin-dan-staff">
            ...
            <form action="{{ route('admin-dan-staff.store') }}" class="p-4 md:p-5" method="POST">
                @csrf
                <div class="gap-2">
                    <div class="mb-2">
