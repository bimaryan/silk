<div id="tambah-matakuliah" tabindex="-1" aria-hidden="true" data-modal-backdrop="static"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 border-b rounded-t md:p-5 dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="tambah-matakuliah">
            ...
            <form action="{{ route('data-mata-kuliah.store') }}" class="p-4 md:p-5" method="POST">
                @csrf
                <div class="gap-2">
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" name="mata_kuliah" id="mata_kuliah" placeholder="Masukan Mata Kuliah"
                            class="block w-full mt-2 border-gray-300 rounded-lg shadow-sm focus:border-green-500 focus:ring focus:ring-green-500 focus:ring-opacity-50">
                        @error('mata_kuliah')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
