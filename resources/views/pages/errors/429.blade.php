...
<body>
    <div class="max-w-md p-6 bg-white border border-gray-200 rounded-lg shadow-lg text-center">
        ...
        <h2 class="text-2xl font-bold text-gray-800 mb-2">429 Too Many Requests</h2>
        <p class="text-gray-600 mb-4">You have made too many requests in a short period. Please try again later.</p>
