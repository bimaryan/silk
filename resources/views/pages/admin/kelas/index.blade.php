                ...
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-2">
                        <button class="justify-center px-4 py-2 text-white bg-green-500 rounded hover:bg-green-800"
                            data-modal-target="import-kelas" data-tooltip-target="import" data-tooltip-placement="left"
                            data-modal-toggle="import-kelas"><i class="fa-solid fa-file-arrow-up"></i>
                        </button>
                    ...
                    <div class="flex items-center gap-2">
                        <form method="GET" action="{{ route('data-kelas.index') }}" class="flex items-center gap-2">
                            <!-- Input pencarian -->
                            ...
                            <!-- Tombol reset -->
                            <a href="{{ route('data-kelas.index') }}" class="p-2 text-white bg-gray-500 rounded-md hover:bg-gray-600">
                                Reset
                            </a>
                        </form>
                    </div>
